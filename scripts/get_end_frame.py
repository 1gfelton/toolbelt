...
if len(sys.argv) < 2:
    print("Usage: python get_end_frame.py path/to/your/video/file.mp4")
    sys.exit()
...
out_name = f"{video_basename}_end_frame.jpg"
output_path = os.path.join(output_dir, out_name)

print(f"Extracting first frame of: {video_file}")
print(f"Output directory: {output_dir}")

cmd = ["ffmpeg", "-sseof", "-3",  "-i", video_file, "-update", "1", "-q:v", "1", output_path]
